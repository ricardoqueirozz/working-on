...
main (int argc, char *argv[])
{
  ...
  std::string deploymentScenario = "test_3s";
  ...
  if (deploymentScenario.compare ("test_3s") == 0)
    {
      gNbNum = 6;
      ueNumPergNb = 1;
    }
  else if (deploymentScenario.compare ("Case1_Omni") == 0)
    {
      gNbNum = 1;
      ueNumPergNb = 1;
    }
  else if (deploymentScenario.compare ("Case2_Omni") == 0)
    {
      gNbNum = 2;
      ueNumPergNb = 1;
    }
  else if (deploymentScenario.compare ("Case3_Omni") == 0)
    {
      gNbNum = 3;
      ueNumPergNb = 1;
    }  
  else if (deploymentScenario.compare ("Case4_Omni") == 0)
    {
      gNbNum = 4;
      ueNumPergNb = 1;
    } 
  else if (deploymentScenario.compare ("Case1_3s") == 0)
    {
      gNbNum = 3;
      ueNumPergNb = 1;
    }
  else if (deploymentScenario.compare ("Case2_3s") == 0)
    {
      gNbNum = 6;
      ueNumPergNb = 1;
    }
  else if (deploymentScenario.compare ("Case3_3s") == 0)
    {
      gNbNum = 9;
      ueNumPergNb = 1;
    }
  else if (deploymentScenario.compare ("Case4_3s") == 0)
    {
      gNbNum = 12;
      ueNumPergNb = 1;
    }
  ...
  if (deploymentScenario.compare ("test_3s") == 0){
      ...
      gnbPositionAlloc->Add (Vector (gNB1x, gNB1y+offset, hBS));
      gnbPositionAlloc->Add (Vector (gNB2x+offset2, gNB2y+offset, hBS));
      gnbPositionAlloc->Add (Vector (gNB3x+offset3, gNB3y+offset, hBS));
    }  
  if (deploymentScenario.compare ("Case1_Omni") == 0){
	  isoGnb = true;
      gNB1x = 35.0;
      gNB1y = 25.0;
      ...
      gnbPositionAlloc->Add (Vector (gNB1x+offset, gNB1y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB2x+offset2+offset, gNB2y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB3x+offset3+offset, gNB3y, hBS));
    }
  else if (deploymentScenario.compare ("Case3_Omni") == 0){
	    isoGnb = true;
	    gNB1x = 17.5;
      ...
      gnbPositionAlloc->Add (Vector (gNB1x+(2*offset), gNB1y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB2x+offset2+(2*offset), gNB2y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB3x+offset3+(2*offset), gNB3y, hBS));
    }  
  else if (deploymentScenario.compare ("Case4_Omni") == 0){
	    isoGnb = true;
      gNB1x = 14.0;
      ...
      // position the base stations
  	  ...
  	  gnbPositionAlloc->Add (Vector (gNB1x+offset, gNB1y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB2x+(offset+offset2), gNB2y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB3x+(offset+offset3), gNB3y, hBS));

  	  gnbPositionAlloc->Add (Vector (gNB1x+(2*offset), gNB1y+offset2, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB2x+((2*offset)+offset2), gNB2y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB3x+((2*offset)+offset3), gNB3y, hBS));

  	  gnbPositionAlloc->Add (Vector (gNB1x+(3*offset), gNB1y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB2x+((3*offset)+offset2), gNB2y, hBS));
  	  gnbPositionAlloc->Add (Vector (gNB3x+((3*offset)+offset3), gNB3y, hBS));
    }  
  ...
  if (deploymentScenario.compare ("Case2_Omni") == 0)
    {
      ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x, ue2y, hUT));
    }
  if (deploymentScenario.compare ("Case3_Omni") == 0)
    {
      ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x, ue2y, hUT));
      ueNodes.Get (2)->GetObject<MobilityModel> ()->SetPosition (Vector (ue1x + offset, ue1y, hUT));
    }
  if (deploymentScenario.compare ("Case4_Omni") == 0)
    {
      ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x, ue2y, hUT));
      ueNodes.Get (2)->GetObject<MobilityModel> ()->SetPosition (Vector (ue1x + offset, ue1y, hUT));
	    ueNodes.Get (3)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x + offset, ue2y, hUT));
    }
  if (deploymentScenario.compare ("Case1_3s") == 0)
    {
      ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x, ue2y, hUT));
      ueNodes.Get (2)->GetObject<MobilityModel> ()->SetPosition (Vector (ue1x + offset, ue1y, hUT));
    }
  if (deploymentScenario.compare ("Case2_3s") == 0)
    {
      ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x, ue2y, hUT));
      ueNodes.Get (2)->GetObject<MobilityModel> ()->SetPosition (Vector (ue1x + offset, ue1y, hUT));
      ueNodes.Get (3)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x + offset, ue2y, hUT));
  ...
  if (deploymentScenario.compare ("Case3_3s") == 0)
    {
      ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x, ue2y, hUT));
      ueNodes.Get (2)->GetObject<MobilityModel> ()->SetPosition (Vector (ue1x + offset, ue1y, hUT));
      ueNodes.Get (3)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x + offset, ue2y, hUT));
  ...
  if (deploymentScenario.compare ("Case4_3s") == 0)
    {
      ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x, ue2y, hUT));
      ueNodes.Get (2)->GetObject<MobilityModel> ()->SetPosition (Vector (ue1x + offset, ue1y, hUT));
      ueNodes.Get (3)->GetObject<MobilityModel> ()->SetPosition (Vector (ue2x + offset, ue2y, hUT));
  ...
  for (uint32_t i = 0; i < gNbNum; ++i)
    {
    	  if ((deploymentScenario.compare ("test_3s") == 0))
	  {
		  ...
		  else if (i==2)
		  {
			  ...
			  Ptr<UniformPlanarArray> antenna0 =
			  ConstCast<UniformPlanarArray> (phy0->GetSpectrumPhy ()->GetAntennaArray ());
			  antenna0->SetAttribute ("BearingAngle", DoubleValue (DegreesToRadians(240))); //-90
		  }
		  else if (i==3)
		  {
			  Ptr<NrGnbPhy> phy0 = nrHelper->GetGnbPhy (gnbNetDev.Get(i),0);
			  Ptr<UniformPlanarArray> antenna0 =
			  ConstCast<UniformPlanarArray> (phy0->GetSpectrumPhy ()->GetAntennaArray ());
			  antenna0->SetAttribute ("BearingAngle", DoubleValue (DegreesToRadians(60))); //-90
		  }
		  ...
		  else if (i==4)
		  {
			  ...
			  Ptr<UniformPlanarArray> antenna0 =
			  ConstCast<UniformPlanarArray> (phy0->GetSpectrumPhy ()->GetAntennaArray ());
			  antenna0->SetAttribute ("BearingAngle", DoubleValue (DegreesToRadians(180))); //-90
		  }
		  else
		  {
			  Ptr<NrGnbPhy> phy0 = nrHelper->GetGnbPhy (gnbNetDev.Get(i),0);
			  Ptr<UniformPlanarArray> antenna0 =
			  ConstCast<UniformPlanarArray> (phy0->GetSpectrumPhy ()->GetAntennaArray ());
			  antenna0->SetAttribute ("BearingAngle", DoubleValue (DegreesToRadians(300))); //-90
		  }
	  }
	  if ((deploymentScenario.compare ("Case1_3s") == 0) or (deploymentScenario.compare ("Case2_3s") == 0) or (deploymentScenario.compare ("Case3_3s") == 0) or (deploymentScenario.compare ("Case4_3s") == 0))
	  {
		  if (i%3==0)
		  {
			  Ptr<NrGnbPhy> phy0 = nrHelper->GetGnbPhy (gnbNetDev.Get(i),0);
  ...
  if (deploymentScenario.compare ("test_3s") == 0) 
    {
      ...
      gnbNetDev.Get (4)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (4));
      gnbNetDev.Get (5)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (5));
    }
  if (deploymentScenario.compare ("Case2_Omni") == 0)
    {
      gnbNetDev.Get (1)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (1));  
  ...
  if (deploymentScenario.compare ("Case3_3s") == 0) 
    {
      ...
      gnbNetDev.Get (4)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (4));
      gnbNetDev.Get (5)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (5));
      gnbNetDev.Get (6)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (6));
      gnbNetDev.Get (7)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (7));
      gnbNetDev.Get (8)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (8));
    }
  if (deploymentScenario.compare ("Case4_3s") == 0) 
    {
      gnbNetDev.Get (1)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (1));
      ...
      gnbNetDev.Get (7)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (7));
      gnbNetDev.Get (8)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (8));
      gnbNetDev.Get (9)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (9));
      gnbNetDev.Get (10)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (10));
      gnbNetDev.Get (11)->GetObject<NrGnbNetDevice> ()->GetPhy (remBwpId)->GetBeamManager ()->ChangeBeamformingVector (ueNetDev.Get (11));
    }
