...
cp -f run_NrMmtc_SimPerScriptCampaign_RemArtigo2_cluster_deploymentScenario_JOB0_Sim_3.sh /home/rqdfhsilva/ns-allinone-3.36/ns-3.36/results_cluster_NrMmtc_SimPerScriptCampaign_RemArtigo2_deploymentScenario
...
sleep $((11 + RANDOM % 50))
srun -N 1 -n 1 ./ns3 --cwd='/home/rqdfhsilva/ns-allinone-3.36/ns-3.36/results_cluster_NrMmtc_SimPerScriptCampaign_RemArtigo2_deploymentScenario/JOB0/Sim_3' --run 'rem-artigo2 --RngRun=492654656509539 --remMode=CoverageArea --scenario=UMa --deploymentScenario=Line_3s --frequency=24.3e9 --outputDir='/home/rqdfhsilva/ns-allinone-3.36/ns-3.36/results_cluster_NrMmtc_SimPerScriptCampaign_RemArtigo2_deploymentScenario/JOB0/Sim_3' --outputDir2='/home/rqdfhsilva/ns-allinone-3.36/ns-3.36/results_cluster_NrMmtc_SimPerScriptCampaign_RemArtigo2_deploymentScenario/JOB0' --remMode=CoverageArea --scenario=InH-OfficeOpen --frequency=3.5e9 --deploymentScenario=Line_3s' > /home/rqdfhsilva/ns-allinone-3.36/ns-3.36/results_cluster_NrMmtc_SimPerScriptCampaign_RemArtigo2_deploymentScenario/JOB0/Sim_3.out 2>&1
